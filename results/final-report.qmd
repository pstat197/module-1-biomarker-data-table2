...
"Fuzzy Intersection (Weighted Combination)"
),
Goal_Change = c(
"Prevent data leakage by selecting features only on training data",
"Increase selection pool from 10→20 proteins for stability",
"Blend t-test and RF rankings using fuzzy weights"
),
Main_Outcome = c(
"Produces realistic, generalizable estimates",
"Avoids 'no proteins selected' errors and expands overlap",
"Enhances performance via complementary feature weighting"
),
Performance = c(
"AUC 0.69–0.76, Acc 0.64–0.75",
"AUC ≈ 0.70, Acc ≈ 0.65",
"Equal (0.69/0.64), T-test (0.71/0.66), RF (0.761/0.745 best)"
),
Key_Insights = c(
"Conservative but honest metrics; prevents data leakage",
"Improves intersection stability and feature coverage",
"RF-heavy strategy yields best performance; FSTL1 consistently top"
)
)

kable(mod_summary,
caption = "Comparison of All Methodological Variations",
align = "l")
...
model_comparison <- data.frame(
  ...
  AUC = c(0.92, 0.83),
  Accuracy = c(0.87, 0.80),
  Main_Strength = c("Sparse, interpretable biomarker selection", 
                    "Captures complex nonlinear relationships"),
  Key_Limitation = c("Assumes linear additive effects", 
                     "Less interpretable, prone to overfitting")
)

# Display neatly formatted table
kable(
  model_comparison,
  caption = "Comparison of LASSO and Random Forest Models for ASD Classification",
  align = "lccll"
)
